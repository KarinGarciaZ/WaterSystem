...
Public Class ReporteServiciosAtendidos
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        CONEXION.Open()
        Dim cmd As New SqlCommand("REPORTESERVICIOSATENDIDOSPER", CONEXION)
        cmd.CommandType = CommandType.StoredProcedure
        Dim adaptador As New SqlDataAdapter()
        adaptador.SelectCommand = New SqlCommand
        adaptador.SelectCommand.Connection = CONEXION
        adaptador.SelectCommand.CommandText = "REPORTESERVICIOSATENDIDOSPER"
        ...
        Reporte.ReportViewer1.LocalReport.ReportPath = "C:\DesImpSist\5\Sistema\Sistema\Reportes\ReportesPar\ReporteServiciosAtendidosPer.rdlc"
